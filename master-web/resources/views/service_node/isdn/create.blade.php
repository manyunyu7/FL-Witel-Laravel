    ...
    <section class="section">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">Tambahkan Data ISDN</h4>
            </div>

            <div class="card-body">
                <form action="{{ url('service-node/isdn/create') }}" method="post">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="tg_no" required class="form-control" value="{{ old('tg_no') }}"
                                    required id="basicInput" placeholder="TG_NO">
                            </div>

                            <div class="form-group">
                                <label for="basicInput">TG Name</label>
                                <input type="text" name="tg_name" required class="form-control" value="{{ old('tg_name') }}"
                                    id=" basicInput" placeholder="TG Name">
                            </div>

                            <div class="form-group">
                                <label for="basicInput">Sub Route Number</label>
                                <input type="text" name="sub_route_number" class="form-control" value="{{ old('sub_route_number') }}"
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="name_customers" class="form-control" value="{{ old('name_customers') }}"
                                    placeholder="Name Customers">
                            </div>

                            <div class="form-group">
                                <label for="basicInput">Signaling Link Number</label>
                                <input type="text" name="signaling link number" class="form-control" value="{{ old('signaling_link_number') }}"
