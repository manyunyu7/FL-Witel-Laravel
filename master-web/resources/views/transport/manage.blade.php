        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    <h3>Manage Data Problem</h3>
                    <p class="text-subtitle text-muted">Gunakan Menu Ini untuk melakukan manajemen Problem</p>
                </div>
                                    ...
                                    <table class="table table-striped dataTable-table" id="table_data">
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-sortable="">Divisi</th>
                                                <th data-sortable="">Order</th>
                                                <th data-sortable="">Perihal</th>
                                        ...
                                        <tbody>
                                            @forelse ($data as $user)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{url('problem/'.$user->id.'/update')}}">
...
@push('script')
    ...
    <script type="text/javascript">
        ...
        $('body').on("click", ".btn-delete", function() {
            var id = $(this).attr("id")
            $(".btn-destroy").attr("href", window.location.origin + "/problem/" + id + "/delete")
            $("#destroy-modal").modal("show")
        });
    </script>
